...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="305e1562-b031-5bf9-9a53-15e06f74db36")}catch(e){}}();
...
import { z } from 'zod';
import { stepCountIs, hasToolCall, generateText, dynamicTool, jsonSchema, tool } from 'ai';
...
var DEFAULT_TIMEOUT = DEFAULT_REQUEST_TIMEOUT_MSEC;
...
var ListTasksResultSchema = z.object({
  tasks: z.array(TaskSchema),
  nextCursor: z.string().optional()
});
var TaskStatusNotificationSchema = z.object({
...
var TaskResultSchema = z.unknown();
...
function createModelFromCustomProvider(customProvider, model, runtimeApiKey) {
  ...
  switch (customProvider.protocol) {
    case "openai-compatible": {
      ...
      return customProvider.useChatCompletions ? openai.chat(model) : openai(model);
    }
...
function getApiKeyHash(apiKey) {
  ...
  return createHash("sha256").update(apiKey).digest("hex").slice(0, API_KEY_HASH_LENGTH);
}
